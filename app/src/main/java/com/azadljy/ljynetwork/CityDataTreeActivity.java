...
public class CityDataTreeActivity extends AppCompatActivity {
    ...
    private List<CityTreeNode> cityTreeNodes;
    ...
    public void show(View v) {
        AlertDialog.Builder builder = new AlertDialog.Builder(CityDataTreeActivity.this);
        View view = LayoutInflater.from(CityDataTreeActivity.this).inflate(R.layout.addressdialog, null);
    ...
    private void ShowPickerView() {// 弹出选择器
        ...
        OptionsPickerView pvOptions = new OptionsPickerView.Builder(this, new OptionsPickerView.OnOptionsSelectListener() {
            ...
            public void onOptionsSelect(int options1, int options2, int options3, View v) {
                ...
                Toast.makeText(CityDataTreeActivity.this, tx, Toast.LENGTH_SHORT).show();
            }
        })
