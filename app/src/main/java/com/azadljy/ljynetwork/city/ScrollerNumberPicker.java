package com.azadljy.ljynetwork.city;
...
public class ScrollerNumberPicker extends View {
	...
	/** 线的默认颜色 */
	private int lineColor = 0xffe0e0e0;
	/** 默认字体 */
	...
	/** 选中时候的字体颜色 */
	private int selectedColor = 0xff4567;
	/** 蒙板高度 */
...
//		canvas.drawLine(0, controlHeight / 2 + unitHeight / 2 - 2,
//				controlWidth, controlHeight / 2 + unitHeight / 2 - 2, linePaint);
		canvas.drawLine(0, controlHeight / 2 - unitHeight / 2,
				controlWidth, controlHeight / 2 - unitHeight / 2, linePaint);
		canvas.drawLine(0, controlHeight / 2 + unitHeight / 2,
				controlWidth, controlHeight / 2 + unitHeight / 2, linePaint);
	}
